...
public partial class TestPdfFileAnalyzer : Form
	...
	private static string RecentFilesName = "PdfFileAnalyzerFiles.txt";
	...
	private void OnLoad(object sender, EventArgs e)
		...
		// program title
		Text = "PdfFileAnalyzer-Version " + PdfReader.VersionNumber + " " + PdfReader.VersionDate + "-\u00a9 2012-2019 Uzi Granot";
		...
		CopyrightTextBox.Rtf =
			...
			"Copyright \u00a9 2012-2019 Uzi Granot. All rights reserved.\\par\\par \n" +
		...
		if(File.Exists(RecentFilesName))
			...
			using(StreamReader Reader = new StreamReader(RecentFilesName, Encoding.ASCII))
				...
				if(RecentFiles.Count == 0) RecentFiles = null;
				}
			}
	...
	private void OpenPdfFile
		...
		AnalysisScreen AnalyzerForm = new AnalysisScreen(Reader);
