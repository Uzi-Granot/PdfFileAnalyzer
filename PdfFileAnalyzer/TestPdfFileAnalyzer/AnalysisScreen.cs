...
namespace TestPdfFileAnalyzer
	...
	public partial class AnalysisScreen : Form
		...
		private void AddDataGrid()
			...
			DataGridViewCellStyle ObjNoCellStyle = new();
			...
			DataGridViewCellStyle ParentCellStyle = new();
		...
		private void OnMouseDoubleClick
			...
			if (e.Button == MouseButtons.Left && e.RowIndex >= 0)
				{
				DisplayText Dialog = new(DisplayMode.ObjectSummary, Reader, (PdfIndirectObject)DataGrid.Rows[e.RowIndex].Tag, null);
				Dialog.ShowDialog();
				}
			return;
			}
		...
		private void OnView(object sender, EventArgs e)
			...
			DisplayText Dialog = new(DisplayMode.ObjectSummary, Reader, (PdfIndirectObject)Rows[0].Tag, null);
			Dialog.ShowDialog();
			return;
			}
		...
		private void OnSummary(object sender, EventArgs e)
			{
			DisplayText Dialog = new(DisplayMode.PdfSummary, Reader, null, null);
			Dialog.ShowDialog();
			return;
			}
